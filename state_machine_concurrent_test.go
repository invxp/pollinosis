...
func TestConcurrent_StartAndReady(t *testing.T) {
	...
	for _, srv := range servers {
		if err := srv.StartConcurrent(); err != nil {
			t.Fatal(err)
		}
	}
...
func TestConcurrent_StartAndReadyToListener(t *testing.T) {
	var servers []*Pollinosis
	...
	cs := CustomListener{}
	for _, srv := range servers {
		if err := srv.StartConcurrent(&cs); err != nil {
			t.Fatal(err)
		}
	}
...
func TestConcurrent_GetSet(t *testing.T) {
	var servers []*Pollinosis
...
func TestConcurrent_TransferLeader(t *testing.T) {
	var servers []*Pollinosis
...
func TestConcurrent_AddRemoveNodeAndGetValue(t *testing.T) {
	var servers []*Pollinosis
...
func TestConcurrent_Snapshot(t *testing.T) {
	var servers []*Pollinosis
